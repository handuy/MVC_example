...
var Ws = (function () {
    ...
    Ws.prototype.EmitMessage = function (websocketMessage) {
        console.log("Hello websocketMessage", websocketMessage)
...
// function getFrame(videoId) {
//     console.log("Chạy hàm getFrame")
//     // let socketUrl = "wss://hocngay.com/socket/video/ws_endpoint"
//     let socketUrl = "ws://localhost:8083/socket/video/ws_endpoint"
//     let socket = new Ws(socketUrl)
//     console.log(socket.__proto__)
//     let totalFrame

//     socket.OnConnect(() => {
//         console.log("Connected and send frame")
//         socket.__proto__.Emit('Encode', videoId)

//         socket.On('TotalFrame', function (msg) {
//             totalFrame = msg
//         })

//         socket.On('CurrentFrame', currentFrame => {
//             let value = (currentFrame * 100) / totalFrame
//             if (value === 100) {
